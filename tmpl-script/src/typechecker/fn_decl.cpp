...
namespace Runtime
{
    ...
    void TypeChecker::HandleFnDeclaration(std::shared_ptr<FunctionDeclaration> fnDecl, bool exported)
    {
        ...
        std::shared_ptr<ComplexValueType> retType = EvaluateType(GetFilename(), fnDecl->GetReturnType());
        ...
        while (it->HasItems())
        {
            ...
            it->Next();
            std::shared_ptr<ComplexValueType> paramType = EvaluateType(GetFilename(), param->GetType());
        ...
        switch(nameNode->GetType())
        {
            ...
            case AST::NodeType::ObjectMember:
            {
                ...
                std::shared_ptr<ComplexValueType> targetType = EvaluateType(GetFilename(), obj->GetObject());
